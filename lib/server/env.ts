...
const envSchema = z.object({
  ...
  GREENHOUSE_BOARD_TOKENS: z.string().default("openai,stripe,coinbase"),
...
export function getEnv() {
  if (!cachedEnv) {
    cachedEnv = envSchema.parse({
      ...
      GREENHOUSE_BOARD_TOKENS: process.env.GREENHOUSE_BOARD_TOKENS ?? "openai,stripe,coinbase",
  ...
  return {
    ...cachedEnv,
    greenhouseBoardTokens: tokenize(cachedEnv.GREENHOUSE_BOARD_TOKENS),
